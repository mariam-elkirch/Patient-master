 ...
 */
public class Work5 extends Fragment {
...
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_work5, container, false);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                fr.replace(R.id.fragment_container,new Loss1());
                fr.commit();
                ...
                for (int i=0;i < Work1.list.size();i++)
                {
                    Log.i("Value of work element "+i, String.valueOf(Work1.list.get(i)));

                }

                double a=Work1.list.get(0);
                double b=Work1.list.get(1);
                double c=Work1.list.get(2);
                double d=Work1.list.get(3);
                double m=Work1.list.get(4);
                ...
                try {
                    mClassifier = (Classifier) weka.core.SerializationHelper.read(assetManager.open("work9.model"));
                ...
                Log.i("model work load","Model work Loaded");
                if(mClassifier==null){
                    Log.i("model not load","Model not Loaded");
                    return;
                }
                final Attribute attributeSepalLength = new Attribute("work1");
                final Attribute attributeSepalWidth = new Attribute("work2");
                final Attribute attributePetalLength = new Attribute("work3");
                final Attribute attributePetalWidth = new Attribute("work4");
                final Attribute attributePetalWidth2 = new Attribute("work5");
